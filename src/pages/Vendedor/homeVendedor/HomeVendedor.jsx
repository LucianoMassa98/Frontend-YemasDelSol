                    ...
                    <div className='filtrado-prod'>
                        <div className='cont-select'>
                            ...
                            <Autocomplete
                                ...
                                options={top100Films}
                                sx={{ width: 270 }}
                                renderInput={(params) => <TextField {...params} placeholder="Ingrese numero o codigo" />}
                            />
                        </div>
