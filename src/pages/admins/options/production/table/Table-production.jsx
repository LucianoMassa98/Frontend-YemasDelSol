...
export default function TableProduction({
  ...
  const sectionClass = tableModal
    ? "with-modal-production"
    : "section-table-production";
  return (
      ...
      <table>
        <thead>
          <tr>
            ...
            {mostrarDelete === false ? <th>Precio</th> : <th></th>}
          </tr>
        </thead>
                ...
                {mostrarDelete === false ? (
                  ...
                  <td>
                    {prod.ProduccionProducto || prod.CompraProducto ? (
                      ...
                      <button
                        type="button"
                        className="btn-delete-production"
