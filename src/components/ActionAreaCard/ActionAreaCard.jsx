    ...
    return (
        <Card sx={{
            ...
            <CardActionArea sx={{ display: "flex", flexDirection: "column" }}>
                ...
                />
                <CardContent sx={{ backgroundColor: "white", display: "flex", justifyContent: "start", padding: "20px" }}>
                    <Box sx={{ minWidth: 180, display: "flex", flexDirection: "column", gap: "15px", alignItems: "start" }}>
                        ...
                        <Box sx={{ display: "flex", justifyContent: "center", gap: "0px", alignItems: "center", width: "100%" }}>
                            <span style={{ width: "65%" }}>
                                Cantidad :
                            </span>
                            <TextField type='number' size='small' id="outlined-basic" label="" InputProps={{
                                sx: {
                                    width: "80%",
